...
class BadgeState extends State<Badge> with TickerProviderStateMixin {
  ...
  Widget _getBadge() {
    ...
    final gradientBorder = widget.badgeStyle.borderGradient != null
        ...
        : null;
    final double effectiveSmallSize = widget.badgeStyle.smallSize ?? 6;
    final double effectiveLargeSize = widget.badgeStyle.largeSize ?? 24;
    Widget badgeView() {
          ...
          return Opacity(
            ...
            child: UnconstrainedBox(
              child: IntrinsicWidth(
                child: SizedBox(
                  height: widget.badgeContent == null
                      ? effectiveSmallSize
                      : effectiveLargeSize,
                  child: AspectRatio(
                    aspectRatio: widget.badgeStyle.shape == BadgeShape.square
                        ? 1.5
                        : 1.0,
                    child: isCustomShape
                        ? CustomPaint(
                        ...
                        : Material(
                            ...
                            child: AnimatedContainer(
                              curve: widget
                                  .badgeAnimation.colorChangeAnimationCurve,
